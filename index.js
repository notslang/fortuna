 ...
 * @description
 * <b>Use random as a singleton for this class!</b>
 * <p>
...
PRNG.prototype = {
  ...
  randomWords: function (nwords, paranoia) {
    ...
    if (readiness === this._NOT_READY) {
      throw new Error("generator isn't seeded");
  ...
  addEntropy: function (data, estimatedEntropy, source) {
    ...
    if (err) {
      throw new Error("random: addEntropy only supports number, array of numbers or string");
    }
  ...
  startCollectors: function () {
    ...
    if (window.addEventListener) {
      ...
      throw new Error("can't attach event");
    }
  ...
  useCookie: function (all_cookies) {
      throw new Error("random: useCookie is unimplemented");
  },*/
